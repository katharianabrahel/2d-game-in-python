...
# COLETAVEL DE ENERGIA
coletavel4 = pygame.Surface((10, 10))
coletavel4.fill('yellow')
coletavel4_rect = coletavel1.get_rect(topleft=(800, 400))
...
while True:
    ...
    tela.blit(fonte.render("Time: " + str(cronometro(100)),
              True, (255, 255, 255)), (1070, 50))
    ...
    if player_rect.colliderect(coletavel4_rect):
        velocidade = True
    ...
    tela.blit(coletavel4, coletavel4_rect)
    ...
    colisao_coletavel(player_rect, coletavel4_rect)
